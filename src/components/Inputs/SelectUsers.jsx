        ...
        <div className='space-y-4 mt-2'>
            {
                selectedUserAvatars.length === 0 && (
                    <button
                        ...
                        className='w-full text-sm text-black outline-none  border border-slate-100 px-2.5 py-3 rounded-md mt-2 flex justify-end items-center'
                    >
                        <LuUser className='mr-2' /> Add Members
                    </button>
                )
            }
